var sankoreLang = {
    ...
    edit: "Modifier", 
    short_desc: "Saisir l'étiquette ici", 
    add: "Nouveau bloc",
    ...
    none: "aucun",
    help: "Aide",
    help_content:"<p><h2>Collection</h2></p>"+
    "<p><h3>Permet d'afficher un ensemble d'images.</h3></p>"+
    ...
    "<li>de modifier les images de l'activité</li></ul>"+
    "<p>En mode édition :</p>"+
    "<ul><li>changez l'étiquette en cliquant sur le champ de texte, </li>"+
